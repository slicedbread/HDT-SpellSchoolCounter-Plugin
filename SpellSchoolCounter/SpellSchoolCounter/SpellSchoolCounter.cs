...
namespace SpellSchoolCounter
{
    ...
    {
        private SchoolCountWidget _playerList = null;
        private SchoolCountWidget _opponentList = null;

        public SpellSchoolCounter(SchoolCountWidget playerList, SchoolCountWidget opponentList)
        {
